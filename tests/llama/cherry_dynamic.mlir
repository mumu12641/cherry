module {
  ...
  cherry.func private @llama_forward(
      ...
      %token_id: i64, 
      %pos: i64,
      %k_cache: !cherry.cherry_tensor<[?xf32]>, // [n_layers, max_seq, dim]
      %v_cache: !cherry.cherry_tensor<[?xf32]>, // [n_layers, max_seq, dim]
  ...
  ) -> (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>) {   
    // %k_cache = cherry.reshape %k_cache_arg shape [12, 1024, 768] : (!cherry.cherry_tensor<[12x1024x768xf32]>) -> !cherry.cherry_tensor<[?xf32]>
    // %v_cache = cherry.reshape %v_cache_arg shape [12, 1024, 768] : (!cherry.cherry_tensor<[12x1024x768xf32]>) -> !cherry.cherry_tensor<[?xf32]>
    ...
    %x = cherry.tensor_slice %embedding_table[%token_id, %c0_i64] sizes [1, 768] 
         : (!cherry.cherry_tensor<[32000x768xf32]>, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
    ...
    %x_final, %k_cache_final, %v_cache_final = scf.for %i = %c0 to %n_layers step %c1 
      iter_args(%curr_x = %x, %curr_k_cache = %k_cache, %curr_v_cache = %v_cache) -> (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>) {
        ...
        %rms_att_w_layer_1 = cherry.tensor_slice %rms_att_weight[%layer, %c0_i64] sizes [1, 768]
            : (!cherry.cherry_tensor<[12x768xf32]>, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %rms_att_w_layer = cherry.reshape %rms_att_w_layer_1 shape [768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        ...
        %wq_layer_1 = cherry.tensor_slice %wq[%layer, %c0_i64, %c0_i64] sizes [1, 768, 768]
            : (!cherry.cherry_tensor<[12x768x768xf32]>, i64, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %wq_layer = cherry.reshape %wq_layer_1 shape [768, 768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        
        %wk_layer_1 = cherry.tensor_slice %wk[%layer, %c0_i64, %c0_i64] sizes [1, 768, 768]
            : (!cherry.cherry_tensor<[12x768x768xf32]>, i64, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %wk_layer = cherry.reshape %wk_layer_1 shape [768, 768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>

        %wv_layer_1 = cherry.tensor_slice %wv[%layer, %c0_i64, %c0_i64] sizes [1, 768, 768]
            : (!cherry.cherry_tensor<[12x768x768xf32]>, i64, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %wv_layer = cherry.reshape %wv_layer_1 shape [768, 768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>

            
        // MatMul: [1, 768] x [768, 768] -> [1, 768]
        // Note: Assuming MatMulOp handles broadcasting or squeezing of the first dim of weights
        %q_raw = cherry.matmul %xb, %wq_layer : (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        %k_raw = cherry.matmul %xb, %wk_layer : (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        %v = cherry.matmul %xb, %wv_layer : (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>

        // A.3 RoPE (Rotary Positional Embedding)
        // TODO
        %q_raw_heads = cherry.reshape %q_raw shape [1, 12, 64] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        %q_rope = cherry.rope %q_raw_heads, %pos : (!cherry.cherry_tensor<[?xf32]>, i64) -> !cherry.cherry_tensor<[?xf32]>
        %q = cherry.reshape %q_rope shape [1, 768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>

        %k_raw_heads = cherry.reshape %k_raw shape [1, 12, 64] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        %k_rope = cherry.rope %k_raw_heads, %pos : (!cherry.cherry_tensor<[?xf32]>, i64) -> !cherry.cherry_tensor<[?xf32]>
        %k = cherry.reshape %k_rope shape [1, 768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>

        
        // %v_raw_heads = cherry.reshape %v_raw shape [1, 12, 64] : (!cherry.cherry_tensor<[1x768xf32]>) -> !cherry.cherry_tensor<[1x12x64xf32]>
        //%v_rope = cherry.rope %v_raw_heads, %pos : (!cherry.cherry_tensor<[1x12x64xf32]>, i64) -> !cherry.cherry_tensor<[1x12x64xf32]>
        //%v = cherry.reshape %v_rope shape [1, 768] : (!cherry.cherry_tensor<[1x12x64xf32]>) -> !cherry.cherry_tensor<[1x768xf32]>

        // A.4 Update KV Cache
        %k_1 = cherry.reshape %k shape [1, 1, 768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        %next_k_cache = cherry.tensor_set_slice %curr_k_cache[%layer, %pos], %k_1 
            : (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>, i64, i64 ) 
            -> !cherry.cherry_tensor<[?xf32]>
        
        %v_1 = cherry.reshape %v shape [1, 1, 768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        ...
        %k_layer_full_1 = cherry.tensor_slice %next_k_cache[%layer, %c0_i64, %c0_i64] sizes [1, 1024, 768]
            : (!cherry.cherry_tensor<[?xf32]>, i64, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %k_layer_full = cherry.reshape %k_layer_full_1 shape [1024, 768]
        ...
        %v_layer_full_1 = cherry.tensor_slice %next_v_cache[%layer, %c0_i64, %c0_i64] sizes [1, 1024, 768]
            : (!cherry.cherry_tensor<[?xf32]>, i64, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %v_layer_full = cherry.reshape %v_layer_full_1 shape [1024, 768]
            : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
            
        %att_out_init = cherry.create_tensor dense<0.0> : tensor<1x12x64xf32> -> !cherry.cherry_tensor<[?xf32]>
            
        %att_out_final_heads = scf.for %h = %c0 to %head_num_index step %c1 
          iter_args(%curr_att_out = %att_out_init) -> (!cherry.cherry_tensor<[?xf32]>) {
            ...
            %q_head = cherry.tensor_slice %q[%c0_i64, %offset] sizes [1, 64]
                : (!cherry.cherry_tensor<[?xf32]>, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
            ...
            %score = cherry.masked_matmul %q_head, %k_head_T, %valid_len
                : (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>, i64) 
                -> !cherry.cherry_tensor<[?xf32]>
            
            %score_scaled = cherry.tensor_mul_scalar %score, %scale_val
                : (!cherry.cherry_tensor<[?xf32]>, f32) -> !cherry.cherry_tensor<[?xf32]>
            ...
            %next_att_out = cherry.tensor_set_slice %curr_att_out[%c0_i64, %h_i64], %context_head_reshape
                : (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
                
            scf.yield %next_att_out : !cherry.cherry_tensor<[?xf32]>
        }
        %att_out_final = cherry.reshape %att_out_final_heads shape [1, 768]
                : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        ...
        %rms_ffn_w_layer_1 = cherry.tensor_slice %rms_ffn_weight[%layer, %c0_i64] sizes [1, 768]
            : (!cherry.cherry_tensor<[12x768xf32]>, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %rms_ffn_w_layer = cherry.reshape %rms_ffn_w_layer_1 shape [768] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        ...
        %w1_layer_1 = cherry.tensor_slice %w1[%layer, %c0_i64, %c0_i64] sizes [1, 768, 2048]
             : (!cherry.cherry_tensor<[12x768x2048xf32]>, i64, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %w1_layer = cherry.reshape %w1_layer_1 shape [768, 2048] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        
        %w3_layer_1 = cherry.tensor_slice %w3[%layer, %c0_i64, %c0_i64] sizes [1, 768, 2048]
             : (!cherry.cherry_tensor<[12x768x2048xf32]>, i64, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %w3_layer = cherry.reshape %w3_layer_1 shape [768, 2048] : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        ...
        // B.3 Activation (SiLU)
        %hb_silu = cherry.tensor_silu %hb : (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        ...
        %w2_layer_1 = cherry.tensor_slice %w2[%layer, %c0_i64, %c0_i64] sizes [1, 2048, 768]
             : (!cherry.cherry_tensor<[12x2048x768xf32]>, i64, i64, i64) -> !cherry.cherry_tensor<[?xf32]>
        %w2_layer = cherry.reshape %w2_layer_1 shape [2048, 768]: (!cherry.cherry_tensor<[?xf32]>) -> !cherry.cherry_tensor<[?xf32]>
        ...
        scf.yield %x_next, %next_k_cache, %next_v_cache : !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>
    }
    ...
    %x_norm = cherry.rmsnorm %x_final scale %rms_final_weight eps 1.000000e-05
        : !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[768xf32]> -> !cherry.cherry_tensor<[?xf32]>
    %logits = cherry.matmul %x_norm, %wcls
        : (!cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[768x32000xf32]>) -> !cherry.cherry_tensor<[?xf32]>

    cherry.return %logits, %k_cache_final, %v_cache_final : !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>
  }
  ...
  cherry.func @host(){
    ...
    %k_cache_init = cherry.create_tensor dense<0.0> : tensor<12x1024x768xf32> -> !cherry.cherry_tensor<[?xf32]>
    %v_cache_init = cherry.create_tensor dense<0.0> : tensor<12x1024x768xf32> -> !cherry.cherry_tensor<[?xf32]>
    ...
    %final_token, %final_pos, %final_k_cache, %final_v_cache = scf.while (%arg_token = %start_token, %arg_pos = %start_pos, %arg_k_cache = %k_cache_init, %arg_v_cache = %v_cache_init) 
        ...
        scf.condition(%cond) %arg_token, %arg_pos, %arg_k_cache, %arg_v_cache : i64, i64, !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>
      } do {
        ^bb0(%curr_token: i64, %curr_pos: i64, %curr_k_cache: !cherry.cherry_tensor<[?xf32]>, %curr_v_cache: !cherry.cherry_tensor<[?xf32]>):
        ...
        %logits, %next_k_cache, %next_v_cache = cherry.call @llama_forward(
            ...
            %rms_ffn, %w1, %w2, %w3,
            %rms_final, %wcls
        ) : (i64, i64, !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>,
        ...
        %arg_max = cherry.argmax %logits dim 1 : (!cherry.cherry_tensor<[?xf32]>) -> (!cherry.cherry_tensor<[1xi64]>)
        ...
        scf.yield %next_token, %next_pos, %next_k_cache, %next_v_cache : i64, i64, !cherry.cherry_tensor<[?xf32]>, !cherry.cherry_tensor<[?xf32]>
      }
